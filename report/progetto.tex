...
Abbiamo esplorato il range di condizioni iniziali tali per cui l’uscita del sistema in anello chiuso converge a $h(x_e, u_e)$ e le abbiamo rappresentate tramite due heatmap in Figura \ref{fig:heatmap}: una che presenta anche il tempo di assestamento e una per la sovraelongazione. 
