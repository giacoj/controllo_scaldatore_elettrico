...
\begin{equation}
   G(j\omega) = \frac{0.002829}{1 + 2j(10.66)\frac{\omega}{0.0922} - \frac{\omega^2}{0.0922^2}}
\end{equation}
...
\begin{align*}
    \mu_d= \frac{\mu^{\star}_d}{|G(\omega_{d,max})|} = \frac{10^3}{1.1178\cdot10^{-4}}= 8.9461\cdot10^6
\end{align*}\\
